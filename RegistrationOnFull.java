...
// Класс представляет вторую панель в процессе полной регистрации, предназначенную для регистрации на устройстве
// Панель позволяет пользователю ввести кодовое слово и, по желанию, ключ учетной записи для восстановления контактов
public class RegistrationOnFull {
    ...
    private static String connectionPassword; // Пароль для соединения с сервером
    private static String idAccaunt; // Идентификатор учетной записи
    private static int PORT; // Порт сервера
    private static RegistrationOnServer registration; // Экземпляр класса для регистрации на сервере
    ...
    public RegistrationOnFull(String IP, String connectionPassword, String accountPassword,
                              String idAccaunt, int PORT, int width, int height){
        this.IP = IP;
    ...
    public static void startFulPassword(){
        ...
        entrance.addActionListener(e -> {
            ...
            System.out.println(account_key_pl);
                ...
                try {
                    ...
                    if(account_key_pl.isEmpty()){
                        ...
                        if (result == JOptionPane.YES_OPTION){
                            ...
                            // Шифрование ключа кодовым словом
                            ...
                            // Запуск панели регистрации на сервере
                            registration = new RegistrationOnServer(IP, PORT, connectionPassword, width, height);
